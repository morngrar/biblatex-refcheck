...
Takes bibliography-file as input, reports on stdout if the file looks OK or not, 
and also provides function check_file() which returns True or False respectively, 
for use in automation of LaTeX compilation.
"""
